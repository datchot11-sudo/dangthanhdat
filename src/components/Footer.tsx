  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {/* About */}
        <div>
          <h3 className="text-2xl font-black text-white mb-6 tracking-tighter">DSHOP</h3>
          <p className="text-sm leading-relaxed mb-6">
            Dshop là cửa hàng chuyên cung cấp các dòng máy chơi game chính hãng, phụ kiện gaming cao cấp và tin tức mới nhất về thế giới trò chơi.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><a href="#" className="hover:text-red-500 transition-colors">Phương thức thanh toán</a></li>
            <li><a href="#" className="hover:text-red-500 transition-colors">Vận chuyển & Giao nhận</a></li>
            <li><a href="#" className="hover:text-red-500 transition-colors">Câu hỏi thường gặp</a></li>
          </ul>
        </div>
